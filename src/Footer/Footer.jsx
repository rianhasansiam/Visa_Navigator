    ...
    return (
      <footer className="bg-gray-100 py-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 text-gray-700">
          <div>
          <h1 className="flex gap-3 items-center  text-xl font-extrabold  "><img className='w-10' src="https://i.ibb.co.com/dBf0TFW/Visa-initial-512.webp" alt="" />VISA NAVIGATOR</h1>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4">Explore Link</h3>
            <ul>
              <li>About Us</li>
              <li>Blog</li>
              <li>Testimonials</li>
